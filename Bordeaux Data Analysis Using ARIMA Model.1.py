...
data = pd.read_csv('Bordeaux.csv',parse_dates=['Date'],index_col='Date',date_parser=dateparse)
print('\n Parsed Data:')
print(data.head(7))
...
data=pd.read_csv('Bordeaux.csv', index_col=0, parse_dates=True)
...
plt.legend(loc='best')
plt.title('Rolling Mean & Standard Deviation - Bordeaux 2007')
...
# Test Statistic > Critical Values. Therefore the null hypothesis is not rejected and the Bordeaux 2007 TS is Stationary.
...
ts_log = np.log(ts)
plt.plot(ts_log)
plt.title('Plot Log TS - Bordeaux 2007', fontsize = 15)
plt.xlabel('year', fontsize = 15)
...
plt.title('Plot Log TS & Moving Average - Bordeaux 2007', Fontsize = 15)
plt.xlabel('year', fontsize = 15)
...
plt.title ('Plot Log Time Series & Exponential Weighted -Bordeaux 2007', fontsize = 15)
plt.xlabel('year', fontsize = 15)
plt.ylabel('price', fontsize = 15)	
...
plt.title ('Plot Log Diff TS -Bordeaux 2007', fontsize = 15)
...
plt.title ('Original Bordeaux 2007', fontsize = 15)
plt.legend(loc='best')
plt.subplot(412)
plt.plot(trend, label='Trend')
plt.legend(loc='best')
plt.title ('Trend Bordeaux 2007', fontsize = 15)
plt.subplot(413)
plt.plot(seasonal,label='Seasonality')
plt.legend(loc='best')
plt.title ('Seasonaity Bordeaux', fontsize = 15)
plt.subplot(414)
plt.plot(residual, label='Residuals')
plt.legend(loc='best')
plt.title ('Residual Bordeaux 2007', fontsize = 15)
plt.tight_layout()
...
plt.title('Bordeaux - RMSE: %.4f'% np.sqrt(sum((predictions_ARIMA-ts)**2)/len(ts)))
